Attribute VB_Name = "ModExamesPeriodicosOFC"
Option Explicit
...
'   com atendimento ate as 11h. Contexto: auditoria / ponto de auditoria.
'
' SAIDA
...
Private Const CC_FIXO As String = "jair.fernandes.external@sonova.com"
...
Public Sub CriarRascunhosExamesPeriodicos()
    ...
    For Each k In dictGrupos.Keys
        ...
        ' Copia fixa em todos os rascunhos, inclusive nas pendencias internas
...
Private Function MontarAssunto(ByVal semGestor As Boolean) As String
    Dim s As String
    s = "[A" & ChrW(199) & ChrW(195) & "O HOJE] A" & ChrW(199) & ChrW(195) & "O NECESS" & ChrW(193) & "RIA | " & _
...
Private Function MontarCorpoHTML(ByVal nomeGestor As String, _
    ...
    ' Alerta dinamico: apresenta a data em que a macro for executada
    h = h & "<div style='background:#7D0041;color:#FFFFFF;padding:10px 14px;" & _
            "margin-bottom:14px;border-radius:4px;font-weight:bold;'>" & _
            "&#9888; A&Ccedil;&Atilde;O DE HOJE | " & Format$(Date, "dd/mm/yyyy") & _
            " &mdash; organize a agenda da equipe para os exames peri&oacute;dicos.</div>"
    ...
    h = h & "<p><b>Contexto e prioridade:</b> teremos uma <b>auditoria</b> e a " & _
            "regularidade dos exames peri&oacute;dicos &eacute; " & _
